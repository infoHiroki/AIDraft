// 単発シート処理クラス
class TanbatsuProcessor {
  
  static process() {
    const config = SHEET_CONFIGS.TANBATSU;
    ...
    console.log(`単発シート処理完了: ${processedCount}件`);
  ...
  static testSingleRow() {
    ...
    console.log(`単発シートテスト完了: ${processedCount}件処理`);
    return processedCount;
  }
}